...
'Drugs have taught an entire generation of Americans the metric system.', 'Do pleasant things yourself, but unpleasant things through others.', 'Cats are intended to teach us that not everything in nature has a function.',
'Stoop and you\'ll be stepped on; stand tall and you\'ll be shot at.', 'The lesson which life repeats and constantly enforces is \'look under foot.\' You are always nearer the divine and the true sources of your power than you think.',
'Public speaking is the art of diluting a two-minute idea with a two-hour vocabulary.', "The less you can live on, the more chance your idea will succeed. This is true even after you’ve 'made it'.",
"The best cure for worry, depression, melancholy, brooding, is to go deliberately forth and try to lift with one's sympathy the gloom of somebody else.", "It is a waste of energy to be angry with a man who behaves badly, just as it is to be angry with a car that won't go.",
"It is better to die on your feet than live on your knees.", "My mother used to say that there are no strangers, only friends you haven't met yet. She's now in a maximum security twilight home in Australia.", "Nothing is as far away as one minute ago.",
"Aristotle was famous for knowing everything. He taught that the brain exists merely to cool the blood and is not involved in the process of thinking. This is true only of certain persons.", "If you live long enough, the venerability factor creeps in; first, you get accused of things you never did, and later, credited for virtues you never had.",
